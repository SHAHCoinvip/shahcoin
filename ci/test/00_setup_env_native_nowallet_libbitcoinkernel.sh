...
export CONTAINER_NAME=ci_native_nowallet_libshahcoinkernel
...
export GOAL="install"
export SHAHCOIN_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
