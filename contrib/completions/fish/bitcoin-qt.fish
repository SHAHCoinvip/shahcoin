...
complete --command shahcoin-qt --no-files

# Extract options
function __fish_shahcoinqt_get_options
...
complete \
    --command shahcoin-qt \
    --arguments "(__fish_shahcoinqt_get_options --nofiles)"
