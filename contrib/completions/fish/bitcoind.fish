...
complete --command shahcoind --no-files

# Extract options
function __fish_shahcoind_get_options
...
complete \
    --command shahcoind \
    --arguments "(__fish_shahcoind_get_options --nofiles)"
