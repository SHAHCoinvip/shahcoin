...
# Extract options
function __fish_shahcoin_tx_get_options
...
# Extract commands
function __fish_shahcoin_tx_get_commands
...
complete \
    --command shahcoin-tx \
    --condition "not __fish_shahcoin_seen_cmd (__fish_shahcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_shahcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command shahcoin-tx \
    --arguments "(__fish_shahcoin_tx_get_commands)" \
    --no-files
