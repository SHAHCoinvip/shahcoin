...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The Shahcoin Core developers",
    r"BitPay Inc\.",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Shahcoin Core developers'
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Shahcoin Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the shahcoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Shahcoin
