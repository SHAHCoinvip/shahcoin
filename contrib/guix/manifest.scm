...
(define* (make-shahcoin-cross-toolchain target
                                       #:key
...
desirable for building Shahcoin Core release binaries."
...
;; failure; see https://github.com/shahcoin/shahcoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-shahcoin-cross-toolchain target)))
