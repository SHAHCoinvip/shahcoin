...
When complete, it will have produced `Shahcoin-Core.zip`.
...
apt install cpio
git clone https://github.com/shahcoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/shahcoin-core/shahcoin-detached-sigs).
