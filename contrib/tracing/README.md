...
The bpftrace examples contain a relative path to the `shahcoind` binary. By
...
```
$ python3 contrib/tracing/p2p_monitor.py ./src/shahcoind
```
...
Shahcoin P2P messages can be larger than 32kb (e.g. `tx`, `block`, ...). The
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./src/shahcoind
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./src/shahcoind
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./src/shahcoind
```
