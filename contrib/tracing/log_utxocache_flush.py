...
"""Example logging SHAHCOIN Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/shahcoind
...
def main(shahcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[shahcoind_with_usdts])
