...
""" Interactive shahcoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Shahcoin Core can enable. It uses BCC
...
def main(shahcoind_path):
    ...
    shahcoind_with_usdts.enable_probe(
