...
This is the endpoint used by shahcoin-cli when a `-rpcwallet=` parameter is passed in.
...
shahcoin-cli createwallet mywallet false false "" false false true

# "params": {"wallet_name": "mywallet", "load_on_startup": true}
shahcoin-cli -named createwallet wallet_name=mywallet load_on_startup=true

# "params": {"args": ["mywallet"], "load_on_startup": true}
shahcoin-cli -named createwallet mywallet load_on_startup=true
```
