...
- [ ] Adding sandbox features, restricting subprocess access to resources and data. See [https://eklitzke.org/multiprocess-shahcoin](https://eklitzke.org/multiprocess-shahcoin).
...
```
cd <SHAHCOIN_SOURCE_DIRECTORY>
make -C depends NO_QT=1 MULTIPROCESS=1
CONFIG_SITE=$PWD/depends/x86_64-pc-linux-gnu/share/config.site ./configure
make
src/shahcoin-node -regtest -printtoconsole -debug=ipc
SHAHCOIND=shahcoin-node test/functional/test_runner.py
```
