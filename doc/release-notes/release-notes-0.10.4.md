SHAHCOIN Core version 0.10.4 is now available from:

  <https://shah.vip/bin/shahcoin-core-0.10.4/>
...
- #6953 `43c2789` Split shahcoin-tx into its own package
- #6953 `dfe0d4d` Include shahcoin-tx binary on Debian/Ubuntu
