Shahcoin Core version 0.11.1 is now available from:

  <https://shahcoin.org/bin/shahcoin-core-0.11.1/>
...
one was randomly violated by all deployed shahcoin software prior to
...
[1] On the Malleability of Shahcoin Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/shahcoin/paper_9.pdf
...
(see https://github.com/shahcoin/shahcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libshahcoinconsensus: avoid a crash in multi-threaded environments
