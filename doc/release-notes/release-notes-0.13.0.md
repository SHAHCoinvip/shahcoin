SHAHCOIN Core version 0.13.0 is now available from:

  <https://shah.vip/bin/shahcoin-core-0.13.0/>
...
compatible peers.
[BIP 152](https://github.com/shahcoin/bips/blob/master/bip-0152.mediawiki)
...
[Pull request](https://github.com/SHAHCoinvip/shahcoin/pull/8035/files), [BIP 32](https://github.com/shahcoin/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/shahcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/shahcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/shahcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/shahcoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of SHAHCOIN Core is expected that
...
Witness)] (https://github.com/shahcoin/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/shahcoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/shahcoin/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/shahcoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/shahcoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/SHAHCoinvip/shahcoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for shahcoin-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use SHAH/kB (MarcoFalke)
...
- #7692 `29b2be6` Remove P2P alert system (SHAHDrak)
...
- #8083 `cd0c513` Add support for dnsseeds with option to filter by serviceshahbits (jonasschnelli)
...
- #8275 `042c323` Remove bad chain alert partition check (SHAHDrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (SHAHDrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (SHAHDrak)
...
- #7613 `3798e5d` Add autocomplete to shahcoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add shahcoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: shahcoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from shahcoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the shahcoin-core repository and website to the About Dialog (MarcoFalke)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (SHAHDrak)
...
- #7773 `7c80e72` Fix comments in tests (SHAHDrak)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for shahcoind procs (MarcoFalke)
...
- #8164 `0f24eaf` [Shahcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of shahcoind startup (laanwj)
...
- #7935 `66ed450` Versionshahbits: GBT support (luke-jr)
...
- #7975 `fc23fee` Update shahcoin-core GitHub links (MarcoFalke)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (SHAHDrak)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/shahcoin/).
