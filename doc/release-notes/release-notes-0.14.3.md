Shahcoin Core version *0.14.3* is now available from:

  <https://shahcoin.org/bin/shahcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/shahcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
