Shahcoin Core version 0.16.0 is now available from:
  ...
  <https://shahcoincore.org/bin/shahcoin-core-0.16.0/>
...
- #11917 `bc66765` Add testnet DNS seed:  seed.testnet.shahcoin.sprovoost.nl (Sjors)
...
- #11970 `b7450cd` Add test coverage for shahcoin-cli multiwallet calls (ryanofsky)
...
- #10997 `affe927` Add option -stdinrpcpass to shahcoin-cli to allow RPC password to be read from standard input (jharvell)
...
- #11621 `1f7695b` [build] Add temp_shahcoin_locale_qrc to CLEAN_QT to fix make distcheck (fanquake)
...
- #11711 `6378e5c` shahcoin_qt.m4: Minor fixes and clean-ups (fanquake)
...
- #11297 `16e4184` Make sure ~/.shahcoin doesn't exist before build (MeshCollider)
...
- #11143 `3aa60b7` Fix include path for shahcoin-config.h (danra)
...
- #10871 `c9a4aa8` Handle getinfo in shahcoin-cli w/ -getinfo (revival of #8843) (achow101)
- #11419 `093074b` Utils: Fix launchctl not being able to stop shahcoind (OmeGak)
...
- #10529 `331352f` Improve shahcoind systemd service file (Flowdalic)
