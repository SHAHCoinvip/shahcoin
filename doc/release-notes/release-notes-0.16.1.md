Shahcoin Core version 0.16.1 is now available from:

  <https://shahcoincore.org/bin/shahcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting shahcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure shahcoind processes are cleaned up when tests end (sdaftuar)
