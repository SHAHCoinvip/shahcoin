...
[BIP 174 PSBT](https://github.com/shahcoin/bips/blob/master/bip-0174.mediawiki) is an interchange format for Shahcoin transactions that are not fully signed
yet, together with relevant metadata to help entities work towards signing it.
It is intended to simplify workflows where multiple parties need to cooperate to
produce a transaction. Examples include hardware wallets, multisig setups, and
[CoinJoin](https://shahcointalk.org/?topic=279249) transactions.
...
- #11962 `0a01843` add seed.shahcoin.sprovoost.nl to DNS seeds (Sjors)
...
- #12723 `310dc61` Qt5: Warning users about invalid-BIP21 URI shahcoin:// (krab)
...
- #13528 `b877c39` Move ShahcoinGUI initializers to class, fix initializer order warning (laanwj)
...
- #13486 `66e1a08` Move rpc/util.cpp from libshahcoin-util to libshahcoin-server (ken2812221)
...
- #13604 `75bea05` Add depends 32-bit arm support for shahcoin-qt (TheCharlatan)
...
- #13696 `2ab7208` Add aarch64 qt depends support for cross compiling shahcoin-qt (TheCharlatan)
...
- #11771 `2dbc4a4` Change invalidtxrequest to use ShahcoinTestFramework (jnewbery)
...
- #12443 `07090c5` Move common args to shahcoin.conf (MarcoFalke)
...
- #11772 `0630974` Change invalidblockrequest to use ShahcoinTestFramework (jnewbery)
...
- #11773 `f0f9732` Change `feature_block.py` to use ShahcoinTestFramework (jnewbery)
- #12839 `40f4baf` Remove travis checkout depth (laanwj)
- #11817 `2a09a78` Change `feature_csv_activation.py` to use ShahcoinTestFramework (jnewbery)
...
- #12856 `27278df` Add Metaclass for ShahcoinTestFramework (WillAyd)
...
- #12882 `d96bdd7` Make `test_shahcoin` pass under ThreadSanitzer (clang). Fix lock-order-inversion (potential deadlock) (practicalswift)
...
- #13687 `9d26b69` travis: Check that ~/.shahcoin is never created (MarcoFalke)
...
- #13811 `660abc1` travis: Run `bench_shahcoin` once (MarcoFalke)
...
- #12102 `7fb8fb4` Apply hardening measures in shahcoind systemd service file (Flowdalic)
- #12652 `55f490a` shahcoin-cli: Provide a better error message when shahcoind is not running (practicalswift)
...
- #12769 `35eb9d6` Add systemd service to shahcoind in debian package (ghost)
...
- #13374 `56f6936` utils and libraries: checking for shahcoin address in translations (kaplanmaxe)
...
- #13603 `453ae5e` shahcoin-tx: Stricter check for valid integers (domob1812)
...
- #13725 `07ce278` Fix shahcoin-cli --version (Empact)
...
- #12877 `2b54155` Use shahcoind in Tor documentation (knoxcard)
...
- #13346 `60f0358` update shahcoin-dot-org links in release-process.md (fanquake)
...
- #13905 `73a09b4` fixed shahcoin-cli -help output for help2man (hebasto)
