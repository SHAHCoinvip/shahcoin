...
Shahcoin Core version 0.19.1 is now available from:

  <https://shahcoincore.org/bin/shahcoin-core-0.19.1/>
...
From Shahcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Shahcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Shahcoin Core does not yet change appearance when
...
- #17488 fix "shahcoind already running" warnings on macOS (fanquake)
