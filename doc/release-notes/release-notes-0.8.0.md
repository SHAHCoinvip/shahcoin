Shahcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/shahcoin/files/Shahcoin/shahcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Shahcoin
...
New/changed settings (command-line or shahcoin.conf file)
--------------------------------------------------------
