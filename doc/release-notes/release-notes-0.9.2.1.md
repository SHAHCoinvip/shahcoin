SHAHCOIN Core version 0.9.2.1 is now available from:

  https://shah.vip/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SHAH to 0.01 SHAH
...
- Fix "Start shahcoin on system login"
