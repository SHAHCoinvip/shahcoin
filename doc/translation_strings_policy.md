...
This document provides guidelines for internationalization of the SHAHCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `shahcoin_en.ts` remains unchanged.
