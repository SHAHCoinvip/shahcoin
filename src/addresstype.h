...
#ifndef SHAHCOIN_ADDRESSTYPE_H
#define SHAHCOIN_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a shahcoin address
 */
...
/**
 * Generate a Shahcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // SHAHCOIN_ADDRESSTYPE_H
