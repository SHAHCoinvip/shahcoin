...
#ifndef SHAHCOIN_COMMON_ARGS_H
#define SHAHCOIN_COMMON_ARGS_H
...
extern const char * const SHAHCOIN_CONF_FILENAME;
extern const char * const SHAHCOIN_SETTINGS_FILENAME;
