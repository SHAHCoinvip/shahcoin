...
class CShahcoinLevelDBLogger : public leveldb::Logger {
public:
    ...
    void Logv(const char * format, va_list ap) override {
            ...
            for (int iter = 0; iter < 2; iter++) {
                ...
                if (p < limit) {
                    ...
                    // Do not use vsnprintf elsewhere in shahcoin source code, see above.
                ...
                LogPrintLevel(BCLog::LEVELDB, BCLog::Level::Debug, "%s", base); // NOLINT(shahcoin-unterminated-logprintf)
                if (base != buffer) {
                    delete[] base;
                }
                break;
...
static leveldb::Options GetOptions(size_t nCacheSize)
{
    ...
    options.info_log = new CShahcoinLevelDBLogger();
