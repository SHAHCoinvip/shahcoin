...
//! @file
//! @brief Common init functions shared by shahcoin-node, shahcoin-wallet, etc.

#ifndef SHAHCOIN_INIT_COMMON_H
#define SHAHCOIN_INIT_COMMON_H
