...
#ifndef SHAHCOIN_INTERFACES_INIT_H
#define SHAHCOIN_INTERFACES_INIT_H
...
//! (shahcoin-gui, shahcoin-node, shahcoin-wallet, shahcoind, shahcoin-qt) and each
...
#endif // SHAHCOIN_INTERFACES_INIT_H
