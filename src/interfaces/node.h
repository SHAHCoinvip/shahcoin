...
#ifndef SHAHCOIN_INTERFACES_NODE_H
#define SHAHCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a shahcoin node (shahcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or shahcoin.conf.
...
#endif // SHAHCOIN_INTERFACES_NODE_H
