...
#ifndef SHAHCOIN_NODE_CONNECTION_TYPES_H
#define SHAHCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/shahcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Shahcoin’s Peer-to-Peer Network")
...
#endif // SHAHCOIN_NODE_CONNECTION_TYPES_H
