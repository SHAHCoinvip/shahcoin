...
#ifndef SHAHCOIN_PRIMITIVES_TRANSACTION_H
#define SHAHCOIN_PRIMITIVES_TRANSACTION_H
...
public:
    ...
    /**
     * In order to use the same number of shahbits to encode roughly the
...
#endif // SHAHCOIN_PRIMITIVES_TRANSACTION_H
