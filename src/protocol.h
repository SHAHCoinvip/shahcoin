...
#ifndef SHAHCOIN_PROTOCOL_H
#define SHAHCOIN_PROTOCOL_H
...
/**
 * Shahcoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all SHAHCOIN Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
