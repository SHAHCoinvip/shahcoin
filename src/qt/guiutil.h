...
#ifndef SHAHCOIN_QT_GUIUTIL_H
#define SHAHCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Shahcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "shahcoin:" URI into recipient object, return true on successful parsing
