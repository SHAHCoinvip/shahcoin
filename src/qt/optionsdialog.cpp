      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->shahcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->shahcoinAtStartup);
    ...
    ui->shahcoinAtStartup->setToolTip(ui->shahcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->shahcoinAtStartup->setText(ui->shahcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openShahcoinConfButton->setToolTip(ui->openShahcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ShahcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->shahcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSSHAHontrols);
...
void OptionsDialog::on_openShahcoinConfButton_clicked()
{
