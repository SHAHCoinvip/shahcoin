...
#ifndef SHAHCOIN_QT_SHAHCOINUNITS_H
#define SHAHCOIN_QT_SHAHCOINUNITS_H
...
/** Shahcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ShahcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ShahcoinUnits(QObject *parent);

    /** Shahcoin units.
      @note Source: https://en.shahcoin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        SHAH,
        mSHAH,
    ...
    //! Number of shahis (1e-8) per unit
