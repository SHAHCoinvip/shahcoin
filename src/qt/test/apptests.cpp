...
//! Entry point for ShahcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ShahcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ShahcoinGUI tests.
void AppTests::guiTests(ShahcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ShahcoinGUI::consoleShown, this, &AppTests::consoleTests);
