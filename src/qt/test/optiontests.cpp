...
{
    // Test regression https://github.com/shahcoin/shahcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/shahcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/shahcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Shahcoin/Shahcoin-Qt.conf and all else left as default,
    // shahcoin-qt should set both -listen and -listenonion to false and start successfully.
