...
#ifndef SHAHCOIN_QT_WALLETFRAME_H
#define SHAHCOIN_QT_WALLETFRAME_H
 ...
 * controls into ShahcoinGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to ShahcoinGUI, thus greatly simplifying merges while
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Shahcoin Transaction */
