...
#ifndef SHAHCOIN_QT_WALLETVIEW_H
#define SHAHCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a shahcoin wallet, and offers access to
...
#endif // SHAHCOIN_QT_WALLETVIEW_H
