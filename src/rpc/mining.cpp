...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated shahcoin to."},
    ...
    return RPCHelpMan{"generatetoaddress",
        "Mine to a specified address and return the block hashes.",
         ...
         RPCExamples{
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated shahcoin to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated shahcoin to."},
...
// NOTE: Unlike wallet RPC (which use SHAH values), mining RPCs follow GBT (BIP 22) in using shahi amounts
static RPCHelpMan prioritisetransaction()
{
    return RPCHelpMan{"prioritisetransaction",
            ...
            "                  DEPRECATED. For forward compatibility use named arguments and omit this parameter."},
                    {"fee_delta", RPCArg::Type::NUM, RPCArg::Optional::NO, "The fee value (in shahis) to add (or subtract, if negative).\n"
        ...
        RPCResult{
            RPCResult::Type::OBJ_DYN, "prioritisation-map", "prioritisation keyed by txid",
            {
                {RPCResult::Type::OBJ, "txid", "", {
                    {RPCResult::Type::NUM, "fee_delta", "transaction fee delta in shahis"},
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
        ...
        "    https://github.com/shahcoin/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/shahcoin/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/shahcoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/shahcoin/bips/blob/master/bip-0145.mediawiki\n",
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::ARR, "transactions", "contents of non-coinbase transactions that should be included in the next block",
                {
                    {RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::NUM, "fee", "difference in value between transaction inputs and outputs (in shahis); for coinbase transactions, this is a negative Number of the total collected block fees (ie, not including the block subsidy); if key is not present, fee is unknown and clients MUST NOT assume there isn't one"},
                ...
                {RPCResult::Type::NUM, "coinbasevalue", "maximum allowable input to coinbase transaction, including the generation award and transaction fees (in shahis)"},
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
        ...
        "See https://en.shahcoin.it/wiki/BIP_0022 for full specification.\n",
        {
