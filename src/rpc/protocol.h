...
#ifndef SHAHCOIN_RPC_PROTOCOL_H
#define SHAHCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in shahcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Shahcoin is not connected
