...
/*
 * Interprets c as 8 groups of 5 shahbits which are the coefficients of a degree 8 polynomial over GF(32),
...
std::string DescriptorChecksum(const Span<const char>& span)
{
     ...
     * This means that changes that only affect the lower 5 shahbits of the position, or only the higher 2 shahbits, will just
