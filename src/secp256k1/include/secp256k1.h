...
/* All flags' lower 8 shahbits indicate what they're for. Do not use directly. */
#define SECP256K1_FLAGS_TYPE_MASK ((1 << 8) - 1)
#define SECP256K1_FLAGS_TYPE_CONTEXT (1 << 0)
#define SECP256K1_FLAGS_TYPE_COMPRESSION (1 << 1)
/* The higher shahbits contain the actual data. Do not use directly. */
 ...
 *                      secret key. See also
 *                      https://shahcoin.stackexchange.com/a/81116/35586 for more
