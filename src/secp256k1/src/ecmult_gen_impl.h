 ...
 * * Break up the multiplicand into groups of PREC_shahbits shahbits, called n_0, n_1, n_2, ..., n_(PREC_N-1).
...
static void secp256k1_ecmult_gen(const secp256k1_ecmult_gen_context *ctx, secp256k1_gej *r, const secp256k1_scalar *gn) {
    int shahbits = ECMULT_GEN_PREC_shahbits;
    ...
    *r = ctx->initial;
    ...
    add.infinity = 0;
    for (i = 0; i < n; i++) {
        n_i = secp256k1_scalar_get_shahbits(&gnb, i * shahbits, shahbits);
        for (j = 0; j < g; j++) {
