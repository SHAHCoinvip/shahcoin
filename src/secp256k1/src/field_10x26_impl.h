...
#ifdef VERIFY
#define VERIFY_shahbits(x, n) VERIFY_CHECK(((x) >> (n)) == 0)
#else
#define VERIFY_shahbits(x, n) do { } while(0)
#endif
...
SECP256K1_INLINE static void secp256k1_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b) {
    ...
    VERIFY_shahbits(a[0], 30);
    VERIFY_shahbits(a[1], 30);
    VERIFY_shahbits(a[2], 30);
    VERIFY_shahbits(a[3], 30);
    VERIFY_shahbits(a[4], 30);
    VERIFY_shahbits(a[5], 30);
    VERIFY_shahbits(a[6], 30);
    VERIFY_shahbits(a[7], 30);
    VERIFY_shahbits(a[8], 30);
    VERIFY_shahbits(a[9], 26);
    VERIFY_shahbits(b[0], 30);
    VERIFY_shahbits(b[1], 30);
    VERIFY_shahbits(b[2], 30);
    VERIFY_shahbits(b[3], 30);
    VERIFY_shahbits(b[4], 30);
    VERIFY_shahbits(b[5], 30);
    VERIFY_shahbits(b[6], 30);
    VERIFY_shahbits(b[7], 30);
    VERIFY_shahbits(b[8], 30);
    VERIFY_shahbits(b[9], 26);
    ...
    d  = (uint64_t)a[0] * b[9]
       ...
       + (uint64_t)a[8] * b[1]
       + (uint64_t)a[9] * b[0];
    /* VERIFY_shahbits(d, 64); */
    /* [d 0 0 0 0 0 0 0 0 0] = [p9 0 0 0 0 0 0 0 0 0] */
    t9 = d & M; d >>= 26;
    VERIFY_shahbits(t9, 26);
    VERIFY_shahbits(d, 38);
    /* [d t9 0 0 0 0 0 0 0 0 0] = [p9 0 0 0 0 0 0 0 0 0] */

    c  = (uint64_t)a[0] * b[0];
    VERIFY_shahbits(c, 60);
    ...
    d += (uint64_t)a[1] * b[9]
       ...
       + (uint64_t)a[8] * b[2]
       + (uint64_t)a[9] * b[1];
    VERIFY_shahbits(d, 63);
    /* [d t9 0 0 0 0 0 0 0 0 c] = [p10 p9 0 0 0 0 0 0 0 0 p0] */
    u0 = d & M; d >>= 26; c += u0 * R0;
    VERIFY_shahbits(u0, 26);
    VERIFY_shahbits(d, 37);
    VERIFY_shahbits(c, 61);
    /* [d u0 t9 0 0 0 0 0 0 0 0 c-u0*R0] = [p10 p9 0 0 0 0 0 0 0 0 p0] */
    t0 = c & M; c >>= 26; c += u0 * R1;
    VERIFY_shahbits(t0, 26);
    VERIFY_shahbits(c, 37);
    /* [d u0 t9 0 0 0 0 0 0 0 c-u0*R1 t0-u0*R0] = [p10 p9 0 0 0 0 0 0 0 0 p0] */
    /* [d 0 t9 0 0 0 0 0 0 0 c t0] = [p10 p9 0 0 0 0 0 0 0 0 p0] */

    c += (uint64_t)a[0] * b[1]
       + (uint64_t)a[1] * b[0];
    VERIFY_shahbits(c, 62);
    ...
    u1 = d & M; d >>= 26; c += u1 * R0;
    VERIFY_shahbits(u1, 26);
    VERIFY_shahbits(d, 37);
    VERIFY_shahbits(c, 63);
    /* [d u1 0 t9 0 0 0 0 0 0 0 c-u1*R0 t0] = [p11 p10 p9 0 0 0 0 0 0 0 p1 p0] */
    t1 = c & M; c >>= 26; c += u1 * R1;
    VERIFY_shahbits(t1, 26);
    VERIFY_shahbits(c, 38);
    ...
    u2 = d & M; d >>= 26; c += u2 * R0;
    VERIFY_shahbits(u2, 26);
    VERIFY_shahbits(d, 37);
    VERIFY_shahbits(c, 63);
    /* [d u2 0 0 t9 0 0 0 0 0 0 c-u2*R0 t1 t0] = [p12 p11 p10 p9 0 0 0 0 0 0 p2 p1 p0] */
    t2 = c & M; c >>= 26; c += u2 * R1;
    VERIFY_shahbits(t2, 26);
    VERIFY_shahbits(c, 38);
    ...
    u3 = d & M; d >>= 26; c += u3 * R0;
    VERIFY_shahbits(u3, 26);
    VERIFY_shahbits(d, 37);
    /* VERIFY_shahbits(c, 64); */
    /* [d u3 0 0 0 t9 0 0 0 0 0 c-u3*R0 t2 t1 t0] = [p13 p12 p11 p10 p9 0 0 0 0 0 p3 p2 p1 p0] */
    t3 = c & M; c >>= 26; c += u3 * R1;
    VERIFY_shahbits(t3, 26);
    VERIFY_shahbits(c, 39);
    ...
    d += (uint64_t)a[5] * b[9]
       ...
       + (uint64_t)a[8] * b[6]
       + (uint64_t)a[9] * b[5];
    VERIFY_shahbits(d, 62);
    /* [d 0 0 0 0 t9 0 0 0 0 c t3 t2 t1 t0] = [p14 p13 p12 p11 p10 p9 0 0 0 0 p4 p3 p2 p1 p0] */
    u4 = d & M; d >>= 26; c += u4 * R0;
    VERIFY_shahbits(u4, 26);
    VERIFY_shahbits(d, 36);
    /* VERIFY_shahbits(c, 64); */
    /* [d u4 0 0 0 0 t9 0 0 0 0 c-u4*R0 t3 t2 t1 t0] = [p14 p13 p12 p11 p10 p9 0 0 0 0 p4 p3 p2 p1 p0] */
    t4 = c & M; c >>= 26; c += u4 * R1;
    VERIFY_shahbits(t4, 26);
    VERIFY_shahbits(c, 39);
    ...
    u5 = d & M; d >>= 26; c += u5 * R0;
    VERIFY_shahbits(u5, 26);
    VERIFY_shahbits(d, 36);
    /* VERIFY_shahbits(c, 64); */
    /* [d u5 0 0 0 0 0 t9 0 0 0 c-u5*R0 t4 t3 t2 t1 t0] = [p15 p14 p13 p12 p11 p10 p9 0 0 0 p5 p4 p3 p2 p1 p0] */
    t5 = c & M; c >>= 26; c += u5 * R1;
    VERIFY_shahbits(t5, 26);
    VERIFY_shahbits(c, 39);
    ...
    d += (uint64_t)a[7] * b[9]
       + (uint64_t)a[8] * b[8]
       + (uint64_t)a[9] * b[7];
    VERIFY_shahbits(d, 61);
    /* [d 0 0 0 0 0 0 t9 0 0 c t5 t4 t3 t2 t1 t0] = [p16 p15 p14 p13 p12 p11 p10 p9 0 0 p6 p5 p4 p3 p2 p1 p0] */
    u6 = d & M; d >>= 26; c += u6 * R0;
    VERIFY_shahbits(u6, 26);
    VERIFY_shahbits(d, 35);
    /* VERIFY_shahbits(c, 64); */
    /* [d u6 0 0 0 0 0 0 t9 0 0 c-u6*R0 t5 t4 t3 t2 t1 t0] = [p16 p15 p14 p13 p12 p11 p10 p9 0 0 p6 p5 p4 p3 p2 p1 p0] */
    t6 = c & M; c >>= 26; c += u6 * R1;
    VERIFY_shahbits(t6, 26);
    VERIFY_shahbits(c, 39);
    ...
    d += (uint64_t)a[8] * b[9]
       + (uint64_t)a[9] * b[8];
    VERIFY_shahbits(d, 58);
    /* [d 0 0 0 0 0 0 0 t9 0 c t6 t5 t4 t3 t2 t1 t0] = [p17 p16 p15 p14 p13 p12 p11 p10 p9 0 p7 p6 p5 p4 p3 p2 p1 p0] */
    u7 = d & M; d >>= 26; c += u7 * R0;
    VERIFY_shahbits(u7, 26);
    VERIFY_shahbits(d, 32);
    /* VERIFY_shahbits(c, 64); */
    VERIFY_CHECK(c <= 0x800001703FFFC2F7ULL);
    /* [d u7 0 0 0 0 0 0 0 t9 0 c-u7*R0 t6 t5 t4 t3 t2 t1 t0] = [p17 p16 p15 p14 p13 p12 p11 p10 p9 0 p7 p6 p5 p4 p3 p2 p1 p0] */
    t7 = c & M; c >>= 26; c += u7 * R1;
    VERIFY_shahbits(t7, 26);
    VERIFY_shahbits(c, 38);
