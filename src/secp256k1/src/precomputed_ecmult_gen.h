...
static secp256k1_ge_storage secp256k1_ecmult_gen_prec_table[ECMULT_GEN_PREC_N(ECMULT_GEN_PREC_shahbits)][ECMULT_GEN_PREC_G(ECMULT_GEN_PREC_shahbits)];
#else
extern const secp256k1_ge_storage secp256k1_ecmult_gen_prec_table[ECMULT_GEN_PREC_N(ECMULT_GEN_PREC_shahbits)][ECMULT_GEN_PREC_G(ECMULT_GEN_PREC_shahbits)];
