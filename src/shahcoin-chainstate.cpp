...
//
// The shahcoin-chainstate executable serves to surface the dependencies required
// by a program wishing to use SHAHCOIN Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from SHAHCOIN Core's coding style.
//
// It is part of the libshahcoinkernel project.
