...
#ifndef SHAHCOIN_TEST_SCRIPTNUM10_H
#define SHAHCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SHAHCOIN Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // SHAHCOIN_TEST_SCRIPTNUM10_H
