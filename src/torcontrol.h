// Copyright (c) 2015-2021 The Shahcoin Core developers
 ...
 */
#ifndef SHAHCOIN_TORCONTROL_H
#define SHAHCOIN_TORCONTROL_H
...
/****** Shahcoin specific TorController implementation ********/
