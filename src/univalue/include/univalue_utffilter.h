...
#ifndef SHAHCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define SHAHCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // SHAHCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
