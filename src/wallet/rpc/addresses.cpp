...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{"getnewaddress",
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new shahcoin address"
                },
                RPCExamples{
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The shahcoin address"},
...
RPCHelpMan addmultisigaddress()
{
    return RPCHelpMan{"addmultisigaddress",
                ...
                "Note: This command is only compatible with legacy wallets.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "The shahcoin addresses or hex-encoded public keys",
                        {
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{"getaddressinfo",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The shahcoin address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The shahcoin address validated."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "shahcoin address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
