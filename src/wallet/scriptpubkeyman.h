...
#ifndef SHAHCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define SHAHCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Shahcoin Core wallet was originally a collection of unrelated private
...
#endif // SHAHCOIN_WALLET_SCRIPTPUBKEYMAN_H
