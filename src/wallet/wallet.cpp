...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/shahcoin/shahcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/shahcoin/shahcoin/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/shahcoin/shahcoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/shahcoin/shahcoin/pull/9371 and the prior sync
        ...
        // https://github.com/shahcoin-core/shahcoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
 ...
 * https://github.com/shahcoin/shahcoin/pull/1393.
 */
