...
#ifndef SHAHCOIN_WALLET_WALLET_H
#define SHAHCOIN_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in shahis) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in shahis)
...
public:
    ...
    /** Absolute maximum transaction fee (in shahis) used by default for the wallet */
...
#endif // SHAHCOIN_WALLET_WALLET_H
