// Copyright (c) 2017-2021 The Shahcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SHAHCOIN_WALLET_WALLETUTIL_H
#define SHAHCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! shahcoin from opening the wallet, thinking it was newly created, and
...
#endif // SHAHCOIN_WALLET_WALLETUTIL_H
