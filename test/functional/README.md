...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The CI linter job also checks this, but [possibly not in all cases](https://github.com/SHAHCoinvip/shahcoin/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the ShahcoinTestFramework, place overrides for the
...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to `True` to
  ...
  mature block subsidies (25x50=1250 SHAH) in its wallet. Using them is much more
...
The [`TestShell`](test-shell.md) class exposes the ShahcoinTestFramework
...
Taken from the [python-shahcoinrpc repository](https://github.com/jgarzik/python-shahcoinrpc).
...
Test objects for interacting with a shahcoind node over the p2p interface.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-shahcoinlib)
