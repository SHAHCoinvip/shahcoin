...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ShahcoinTestFramework
    pass


class ExampleTest(ShahcoinTestFramework):
    # Each functional test is a subclass of the ShahcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ShahcoinTestFramework class so other tests can use it."""
