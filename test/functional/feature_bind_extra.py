...
"""
Test starting shahcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(ShahcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that shahcoind has bound on "::1" (for RPC) and "::" (for P2P).
