...
class RESTTest (ShahcoinTestFramework):
    ...
    def run_test(self):
        ...
        for key in ['hash', 'confirmations', 'height', 'version', 'merkleroot', 'time', 'nonce', 'shahbits', 'difficulty', 'chainwork', 'previousblockhash']:
