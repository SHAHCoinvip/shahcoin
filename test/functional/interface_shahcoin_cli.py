...
class TestShahcoinCli(ShahcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test -getinfo and shahcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and shahcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test shahcoin-cli -generate with -rpcwallet in multiwallet mode.
