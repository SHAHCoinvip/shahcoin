...
class RawTransactionsTest(ShahcoinTestFramework):
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 SHAH/kvB
        ...
        # Fee rate is 0.20000000 SHAH/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/SHAHCoinvip/shahcoin/issues/20579)
