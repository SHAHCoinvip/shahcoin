...
Verify that a shahcoind node can use an external signer command.
...
class RPCSignerTest(ShahcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart shahcoind with -signer=<cmd>',
