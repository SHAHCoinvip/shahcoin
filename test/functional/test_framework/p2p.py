...
"""Test objects for interacting with a shahcoind node over the p2p protocol.

The P2PInterface objects interact with the shahcoind nodes under test using the
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor):
        ...
        logger.debug('Listening for Shahcoin Node with id: {}'.format(connect_id))
