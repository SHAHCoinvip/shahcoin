...
class TestShell:
    """Wrapper Class for ShahcoinTestFramework.

    The TestShell class extends the ShahcoinTestFramework
    ...
    class __TestShell(ShahcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ShahcoinTestFramework child class.
            self.num_nodes = 1
