...
class MiniWallet:
    def __init__(self, test_node, *, mode=MiniWalletMode.ADDRESS_OP_TRUE):
        ...
        # (see method ShahcoinTestFramework._initialize_chain())
    ...
    def send_to(self, *, from_node, scriptPubKey, amount, fee=1000):
        ...
        fixed fee given in shahi is used.
    ...
    def create_self_transfer(self, *,
        ...
        """Create and return a tx with the specified fee. If fee is 0, use fee_rate, where the resulting fee may be exact or at most one shahi higher than needed."""
