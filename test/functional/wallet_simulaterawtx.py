...
class SimulateTxTest(ShahcoinTestFramework):
    ...
    def run_test(self):
        ...
        #       wallet                  tx3                             tx4
        #       w0                      -5 - shahcoin_fee + 4.9999       -5 - shahcoin_fee
        #       w1                      0                               +4.9999
        assert_approx(w0.simulaterawtransaction([tx1, tx3])["balance_change"], -Decimal("5") - shahcoin_fee + Decimal("4.9999"))
        assert_approx(w1.simulaterawtransaction([tx1, tx3])["balance_change"], 0)
        assert_approx(w0.simulaterawtransaction([tx1, tx4])["balance_change"], -Decimal("5") - shahcoin_fee)
        ...
        tx2 = funding["hex"]
        shahcoin_fee2 = Decimal(funding["fee"])
        assert_approx(w0.simulaterawtransaction([tx2])["balance_change"], -(Decimal("10") + shahcoin_fee2))
