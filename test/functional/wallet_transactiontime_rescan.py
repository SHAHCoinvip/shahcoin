...
class TransactionTimeRescanTest(ShahcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine SHAH and create transactions
        ...
        # generate some SHAH to create transactions and check blockcount
        ...
        # send 10 SHAH to user's first watch-only address
        self.log.info('Send 10 SHAH to user')
        ...
        # send 5 SHAH to our second watch-only address
        self.log.info('Send 5 SHAH to user')
        ...
        # send 1 SHAH to our third watch-only address
        self.log.info('Send 1 SHAH to user')
