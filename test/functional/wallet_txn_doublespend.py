...
class TxnMallTest(ShahcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 SHAH:
        ...
        # First: use raw transaction API to send 1240 SHAH to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SHAH coin each
        ...
        # Node0's balance should be starting balance, plus 50SHAH for another
        ...
        # Node0's total balance should be starting balance, plus 100SHAH for
