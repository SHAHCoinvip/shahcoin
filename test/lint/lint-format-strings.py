...
def main():
    ...
    for s in FUNCTION_NAMES_AND_NUMBER_OF_LEADING_ARGUMENTS:
        ...
        for matching_file in matching_files:
            if not re.search('^src/(leveldb|secp256k1|minisketch|tinyformat|test/fuzz/strprintf.cpp)|contrib/devtools/shahcoin-tidy/example_logprintf.cpp', matching_file):
